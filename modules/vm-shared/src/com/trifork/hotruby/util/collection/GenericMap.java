...
abstract class GenericMap implements Map
{
    ...
    /**
     * I don't quite understand why we need to replace this method
     * from AbstractCollection, but it has been observed that toArray
     * returns the *reverse* order of elements. --Kresten
     */
                                     ...
                                     Iterator it)
    {
        ...
        if (arr != null && arr.length >= size) {
            ...
            out = (Object[]) java.lang.reflect.Array.newInstance
